...
try
{
    var starWarsApp = new StarWarsApp(new PlanetReader(new MockStarWarsApiDataReader(),new ApiDataReader()),
    new ApiDataPrinter(), new ConsoleInteractor(), new PlanetSelector());
    await starWarsApp.Run(baseAddress,requestUri);
